<template>
    <div class="privacy-policy">
      ...
      <div class="contentPrivacy">
        ...
        <br>
        <br>
        <p>Bem-vindo à Política de Privacidade do Diet System. Esta política descreve como coletamos, usamos e protegemos suas informações pessoais quando você utiliza nossos serviços.</p>
  
        <h2>1. Informações que Coletamos</h2>
        <p>Coletamos vários tipos de informações para fornecer e melhorar nossos serviços para você:</p>
        <ul>
          <li><strong>Informações Pessoais:</strong> Nome, endereço de e-mail, número de telefone e outras informações que você fornece ao se registrar.</li>
          <li><strong>Informações de Uso:</strong> Detalhes de como você usa nosso serviço, incluindo dados de login, histórico de navegação e preferências.</li>
        </ul>
        ...
        <ul>
          ...
          <li>Comunicar-se com você, seja diretamente ou através de um de nossos parceiros, incluindo para atendimento ao cliente, para fornecer atualizações e outras informações relacionadas ao serviço, e para fins de marketing e promoção.</li>
        ...
        <ul>
          <li>Com prestadores de serviços que realizam serviços em nosso nome.</li>
        ...
        <p>Você tem o direito de acessar, corrigir ou excluir suas informações pessoais que mantemos. Para exercer esses direitos, entre em contato conosco através dos meios fornecidos nesta política.</p>
        ...
        <ul>
          <li><strong>Email:</strong> support@dietsystem.com</li>
          <li><strong>Endereço:</strong> Rua Exemplo, 123, Cidade Exemplo, País Exemplo</li>
        </ul>
      </div>
    </div>
</template>
